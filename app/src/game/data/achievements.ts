...
export const ACHIEVEMENT_DEFS: Omit<Achievement, 'unlocked'>[] = [
  ...
  // ===== 四星通关成就（每关四星评价奖励金币）=====
  {
    ...
    name: '厨房四星',
    description: '厨房关卡四星评价通关',
    condition: '(levelStars.kitchen || 0) >= 4',
    conditionDescription: '厨房四星评价通关',
    reward: 200,
  },
  {
    id: 'three_star_sewer',
    name: '下水道四星',
    description: '下水道关卡四星评价通关',
    condition: '(levelStars.sewer || 0) >= 4',
    conditionDescription: '下水道四星评价通关',
    reward: 200,
  },
  {
    id: 'three_star_dump',
    name: '垃圾场四星',
    description: '垃圾场关卡四星评价通关',
    condition: '(levelStars.dump || 0) >= 4',
    conditionDescription: '垃圾场四星评价通关',
    reward: 200,
  },
  {
    id: 'three_star_basement',
    name: '地下室四星',
    description: '地下室关卡四星评价通关',
    condition: '(levelStars.basement || 0) >= 4',
    conditionDescription: '地下室四星评价通关',
    reward: 200,
  },
  {
    id: 'three_star_street',
    name: '街道四星',
    description: '城市街道关卡四星评价通关',
    condition: '(levelStars.street || 0) >= 4',
    conditionDescription: '街道四星评价通关',
    reward: 200,
  },
  {
    id: 'three_star_rooftop',
    name: '天台四星',
    description: '天台关卡四星评价通关',
    condition: '(levelStars.rooftop || 0) >= 4',
    conditionDescription: '天台四星评价通关',
    reward: 200,
  },
  {
    id: 'three_star_hospital',
    name: '医院四星',
    description: '废弃医院关卡四星评价通关',
    condition: '(levelStars.hospital || 0) >= 4',
    conditionDescription: '医院四星评价通关',
    reward: 200,
  },
  {
    id: 'three_star_subway',
    name: '地铁四星',
    description: '废弃地铁关卡四星评价通关',
    condition: '(levelStars.subway || 0) >= 4',
    conditionDescription: '地铁四星评价通关',
    reward: 200,
  },
  {
    id: 'three_star_supermarket',
    name: '超市四星',
    description: '废弃超市关卡四星评价通关',
    condition: '(levelStars.supermarket || 0) >= 4',
    conditionDescription: '超市四星评价通关',
    reward: 200,
  },
  {
    id: 'three_star_school',
    name: '学校四星',
    description: '废弃学校关卡四星评价通关',
    condition: '(levelStars.school || 0) >= 4',
    conditionDescription: '学校四星评价通关',
    reward: 200,
  },
  {
    id: 'three_star_nest',
    name: '巢穴四星',
    description: '蟑螂巢穴关卡四星评价通关',
    condition: '(levelStars.nest || 0) >= 4',
    conditionDescription: '巢穴四星评价通关',
    reward: 300,
  },
  // ===== 困难关四星通关成就（巢穴后 6 个困难关，独立关卡 ID）=====
  {
    id: 'three_star_rooftop_hard',
    name: '天台·困难四星',
    description: '天台困难关四星评价通关',
    condition: "(levelStars['rooftop__hard'] || 0) >= 4",
    conditionDescription: '天台困难关四星评价通关',
    reward: 300,
  },
  {
    id: 'three_star_hospital_hard',
    name: '医院·困难四星',
    description: '废弃医院困难关四星评价通关',
    condition: "(levelStars['hospital__hard'] || 0) >= 4",
    conditionDescription: '医院困难关四星评价通关',
    reward: 300,
  },
  {
    id: 'three_star_subway_hard',
    name: '地铁·困难四星',
    description: '废弃地铁困难关四星评价通关',
    condition: "(levelStars['subway__hard'] || 0) >= 4",
    conditionDescription: '地铁困难关四星评价通关',
    reward: 300,
  },
  {
    id: 'three_star_supermarket_hard',
    name: '超市·困难四星',
    description: '废弃超市困难关四星评价通关',
    condition: "(levelStars['supermarket__hard'] || 0) >= 4",
    conditionDescription: '超市困难关四星评价通关',
    reward: 300,
  },
  {
    id: 'three_star_school_hard',
    name: '学校·困难四星',
    description: '废弃学校困难关四星评价通关',
    condition: "(levelStars['school__hard'] || 0) >= 4",
    conditionDescription: '学校困难关四星评价通关',
    reward: 300,
  },
  {
    id: 'three_star_nest_hard',
    name: '巢穴·困难四星',
    description: '蟑螂巢穴困难关四星评价通关',
    condition: "(levelStars['nest__hard'] || 0) >= 4",
    conditionDescription: '巢穴困难关四星评价通关',
    reward: 400,
  },
];
