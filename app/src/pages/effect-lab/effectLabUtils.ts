...
const KEY_LABELS: Record<string, string> = {
  ...
  spreadY: 'Y 散布范围(px)',
  burstCount: '爆裂数量',
  burstSpreadDist: '爆裂散布半径(px)',
  burstYScale: '散布 Y 轴压扁',
  glassCount: '玻璃碎片数量',
  layers: '闪光层数',
  angleJitter: '角度抖动(rad)',
  trailCount: '拖尾点数量',
  shardCount: '环绕碎片数量',
  particleCount: '粒子数量',
  waveCount: '气流线数量',
  gustCount: '阵风前沿数量',
  dropCount: '粘液滴数量',
  dropAngleJitter: '粘液滴角度抖动',
  plusCount: '+号数量',
  plusCycle: '+号循环周期(s)',
  plusOrbitSpread: '+号轨道散布(rad)',
  emberCount: '余烬数量',
  emberOffsetYBase: '余烬 Y 偏移基础(px)',
  emberOffsetYRange: '余烬 Y 偏移范围(px)',
  countdownThreshold: '倒计时阈值(s)',
  sparkChance: '火花概率/帧',
  sparkOffsetXBase: '火花 X 偏移基础(px)',
  sparkOffsetXRange: '火花 X 偏移范围(px)',
  sparkOffsetYBase: '火花 Y 偏移基础(px)',
  sparkOffsetYRange: '火花 Y 偏移范围(px)',
  burstThreshold: '爆闪阈值(s)',
  burstIntensityMin: '爆闪强度阈值',
  spawnRate: '生成速率(/s)',
  spawnY: '生成 Y 位置(px)',
  spawnEdgeOffset: '边缘生成偏移(px)',
  timerMin: '计时器下限(s)',
  timerRandMax: '计时器随机上限(s)',
  chance: '触发概率',
